...
void test_matmul_identity() {
    ...
    timed([&]{ vec::matmul(eye, a, out, 2, 2, 2); });
...
void test_matmul_known() {
    ...
    timed([&]{ vec::matmul(a, b, out, 2, 2, 2); });
...
void test_matmul_nonsquare() {
    ...
    timed([&]{ vec::matmul(a, b, out, 2, 3, 2); });
...
void test_matmul_row_col() {
    ...
    timed([&]{ vec::matmul(a, b, out, 1, 4, 1); });
...
void test_matvec_identity() {
    ...
    timed([&]{ vec::matvec(eye, x, out, 3, 3); });
